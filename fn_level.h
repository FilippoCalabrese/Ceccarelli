 ...
 */
int fn_level_get_tile(fn_level_t * lv, size_t x, size_t y);
 ...
 */
int fn_level_get_raw(fn_level_t * lv, size_t x, size_t y);
 ...
 */
void fn_level_set_solid(fn_level_t * lv, int x, int y, int solid);
 ...
 */
int fn_level_get_pixelsize(fn_level_t * lv);
